...
export function buildMcpServerCard(appVersion: string) {
  ...
  return {
    ...
    serverInfo: {
      ...
      websiteUrl: "https://getownresume.netlify.app/",
      description:
      ...
      icons: [
        { src: "https://getownresume.netlify.app/icon/light.svg", mimeType: "image/svg+xml", theme: "light" as const },
        { src: "https://getownresume.netlify.app/icon/dark.svg", mimeType: "image/svg+xml", theme: "dark" as const },
      ],
    },
    tools,
    prompts,
