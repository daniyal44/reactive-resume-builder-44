...
import { getLocale, isRTL, loadLocale, type Locale } from "@/utils/locale";
...
const appName = "AI Resume Builder";
const tagline = "Create A free open-source resume builder";
const title = `${appName} | ${tagline}`;
const description =
  "AI Resume Builder | Create a free open-source resume builder that simplifies the process of creating, updating, and sharing your resume.";
...
export const Route = createRootRouteWithContext<RouterContext>()({
  ...
  head: () => {
    const appUrl = process.env.APP_URL ?? "https://getownresume.netlify.app/";

    return {
      links: [
        { rel: "stylesheet", href: appCss },
        // Icons
        { rel: "icon", href: "/light.ico", type: "image/x-icon", sizes: "128x128" },
        { rel: "icon", href: "/light.ico", type: "image/svg+xml", sizes: "256x256 any" },
