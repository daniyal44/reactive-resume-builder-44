    ...
    <SectionBase type="information" className="space-y-4">
      ...
      <div className="flex flex-wrap gap-0.5">
        <Button
          ...
          nativeButton={false}
          render={
            <a href="https://docs.getownresume.netlify.app/" target="_blank" rel="noopener">
        ...
        <Button
          ...
          nativeButton={false}
          render={
            <a href="https://github.com/daniyal44/reactive-resume-builder-44" target="_blank" rel="noopener">
        ...
        <Button
          ...
          nativeButton={false}
          render={
            <a href="https://github.com/daniyal44/reactive-resume-builder-44/issues" target="_blank" rel="noopener">
