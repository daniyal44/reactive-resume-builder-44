...
3. In the new version at [https://getownresume.netlify.app/](https://getownresume.netlify.app/), create a new account or log in
...
If you encounter any problems accessing v4 or have questions about migrating your resumes, feel free to open an issue on [GitHub](https://github.com/daniyal44/reactive-resume-builder-44/issues).
