...
<Info>
  If you're self-hosting, replace `https://getownresume.netlify.app/` with your instance URL. The API is served under `/api/openapi`.
</Info>
...
```bash
curl -X PATCH "https://getownresume.netlify.app/api/openapi/resume/YOUR_RESUME_ID" \
