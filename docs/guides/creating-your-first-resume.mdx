...
<Steps>
  <Step title="Log in to your account">
    Head over to [https://getownresume.netlify.app](https://getownresume.netlify.app) and log in with your account credentials.
...
<Step title="Click “Create a new resume”">
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `https://getownresume.netlify.app/{username}/{slug}`.
    </Warning>
