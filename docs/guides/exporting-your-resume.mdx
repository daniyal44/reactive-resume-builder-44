...
<Tip>
  You can access the complete JSON schema at
  [`https://getownresume.netlify.app/schema.json`](https://getownresume.netlify.app/schema.json). Referencing this is
  helpful for validating your resume JSON or providing a detailed schema reference when collaborating with AI
  assistants.
</Tip>
