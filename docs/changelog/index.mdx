...
## Fixes
- Fixed [#2865](https://github.com/daniyal44/reactive-resume-builder-44/issues/2865), incorrect spacing between resume section items in shared layouts.
- Fixed [#2868](https://github.com/daniyal44/reactive-resume-builder-44/issues/2868) affecting resume item presentation and linked titles in shared item components.

## Maintenance & CI
- Downgraded the Cosign installer action to v3 in the Docker build workflow for more reliable image signing.
- Synced translation catalogs from Crowdin. [#2864](https://github.com/daniyal44/reactive-resume-builder-44/pull/2864)
...
- Generated printer pages now set a meaningful document title from the resume owner's name (`<Name> - Resume`) for cleaner PDF metadata and tab titles. [#2863](https://github.com/daniyal44/reactive-resume-builder-44/pull/2863)

## Fixes
- Fixed [#2733](https://github.com/daniyal44/reactive-resume-builder-44/issues/2733), where date ranges could appear on a separate line unexpectedly in resume items. [#2862](https://github.com/daniyal44/reactive-resume-builder-44/pull/2862)
...
## Features
- Implemented OAuth 2.1 support for MCP authentication, thanks to @5queezer. [#2829](https://github.com/daniyal44/reactive-resume-builder-44/pull/2829)
- Migrated from using Biome to Oxlint/Oxfmt for linting and formatting, with a new autofix CI workflow. [#2822](https://github.com/daniyal44/reactive-resume-builder-44/pull/2822)

## Fixes
- Fixed an issue with the slider component for "Sidebar Width" in the resume builder. [#2830](https://github.com/daniyal44/reactive-resume-builder-44/issues/2830)
</Update>

<Update label="v5.0.13" description="19th March 2026">
## Features & Improvements
- Added **Job Listings with AI-Powered Resume Tailoring**, a major new feature that integrates job search (via JSearch API) directly into the dashboard with AI-driven resume tailoring to match job descriptions. [#2788](https://github.com/daniyal44/reactive-resume-builder-44/pull/2788)
...
- Added **DOCX resume export** — generate and download tailored resumes as Word documents. [#2788](https://github.com/daniyal44/reactive-resume-builder-44/pull/2788)
...
- Migrated from **Biome to Oxlint/Oxfmt** for linting and formatting, with a new autofix CI workflow. [#2822](https://github.com/daniyal44/reactive-resume-builder-44/pull/2822)
...
- Synced translations from Crowdin. [#2820](https://github.com/daniyal44/reactive-resume-builder-44/pull/2820), [#2824](https://github.com/daniyal44/reactive-resume-builder-44/pull/2824)
- Updated French translation for 'Volunteer' to 'Bénévolat'. [#2823](https://github.com/daniyal44/reactive-resume-builder-44/pull/2823)
...
## Fixes
- Show section titles for summary-type custom sections in the resume builder. [#2744](https://github.com/daniyal44/reactive-resume-builder-44/pull/2744)
- Prevent browser password managers and Edge autofill/save prompts from appearing on AI settings API key fields. [#2719](https://github.com/daniyal44/reactive-resume-builder-44/pull/2719)
- Replace deprecated Tailwind CSS classes: use `inset-s-*`/`inset-e-*` instead of `start-*`/`end-*`.
- Fix PDF downloader to work correctly in offline mode. [#2743](https://github.com/daniyal44/reactive-resume-builder-44/pull/2743)
- Make bold formatting visible for `<strong>` in the resume rich text editor (uses plain `font-weight: bold` fallback if the CSS variable is unset). Fixes [#2730](https://github.com/daniyal44/reactive-resume-builder-44/issues/2730)
- Prevent credentials sign-in from dropping `session_token` Set-Cookie, improves login reliability. [#2718](https://github.com/daniyal44/reactive-resume-builder-44/pull/2718)
- Remove redundant `resume-` prefix from download filename; add spacing between pages in shared view. [#2709](https://github.com/daniyal44/reactive-resume-builder-44/pull/2709)
- Normalize autocomplete tokens for login and register forms. [#2714](https://github.com/daniyal44/reactive-resume-builder-44/pull/2714)
- Fix improper chips reordering and update dependency/translations. [#2711](https://github.com/daniyal44/reactive-resume-builder-44/issues/2711)
...
## Features & Improvements
- Implemented Atomic Resume Patching API for fine-grained, partial updates to resumes via a new PATCH endpoint. [#2692](https://github.com/daniyal44/reactive-resume-builder-44/pull/2692)
- API endpoint `PUT /resume/{id}` now returns the updated resume object rather than void, with explicit DTOs for input/output. [#2688](https://github.com/daniyal44/reactive-resume-builder-44/pull/2688)
...
## Fixes
- Fixed keyword spacing issue in the interests section. [#2631](https://github.com/daniyal44/reactive-resume-builder-44/pull/2631)
...
- Sidebar builder now arranges dynamically based on the section type in each template. [#2564](https://github.com/daniyal44/reactive-resume-builder-44/pull/2603)
- Added PWA (Progressive Web App) support and updated PDF example file links in documentation.

## Fixes
- Removed extra spacing when proficiency is empty. [#2607](https://github.com/daniyal44/reactive-resume-builder-44/pull/2626)
...
- Improved RTL support across the app, thanks to @obreo. [(link)](https://github.com/daniyal44/reactive-resume-builder-44/pull/2583)
...
And much more! Explore the new version and share your feedback via [contact](https://mdkworks.online/#contact) or [GitHub issues](https://github.com/daniyal44/reactive-resume-builder-44/issues).
</Update>
