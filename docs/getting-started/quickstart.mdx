...
The easiest way to use Reactive Resume is through our cloud version at [rxresu.me](https://getownresume.netlify.app/). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [rxresu.me](https://getownresume.netlify.app/) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
<Steps>
	<Step title="Clone the Repository">
		```bash git clone https://github.com/daniyal44/reactive-resume-builder-44.git cd Reactive-Resume ```
	</Step>
...
| `APP_URL`          | Public URL of your Application | `https://getownresume.netlify.app/`                     |
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/daniyal44/reactive-resume-builder-44/issues) or reach out via
  [email](mailto:m.daniyalkhan490@gmail.com).
</Note>
