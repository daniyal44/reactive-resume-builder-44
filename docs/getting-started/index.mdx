...
<AccordionGroup>
	<Accordion title="Completely Free & Open Source" icon="code-branch">
		...
		entire codebase is available on [GitHub](https://github.com/daniyal44/reactive-resume-builder-44).
	</Accordion>
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/daniyal44/reactive-resume-builder-44">
...
<Note>
  **Need help?** Feel free to reach out via [email](mailto:m.daniyalkhan490@gmail.com) or open an issue on GitHub.
</Note>
