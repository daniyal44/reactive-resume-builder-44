...
- **Service Operator**: Muhammad Daniyal Khan
- **Contact**: m.daniyalkhan490@gmail.com
- **Service URL**: https://getownresume.netlify.app/
...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>rxresu.me</code>, the
  project's published support contact is <code>m.daniyalkhan490@gmail.com</code>. Replace the placeholders above with
  the correct operator details for your deployment if you are self-hosting.
</Note>
