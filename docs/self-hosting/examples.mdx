...
<Info>
  **Help others by sharing your setup!** If you have a working configuration that isn't covered here, I'd love to
  include it. Simply [open a pull request](https://github.com/daniyal44/reactive-resume-builder-44) with your example
  added to this page. Your contribution helps the community and makes self-hosting easier for everyone.
</Info>
...
services:
  ...
  reactive_resume:
    image: daniyal44/reactive-resume-builder-44:latest
    restart: unless-stopped
    environment:
...
services:
  ...
  reactive_resume:
    image: ghcr.io/daniyal44/reactive-resume-builder-44:latest
    networks:
      - traefik_network
      - reactive_resume_network
    volumes:
...
To contribute, [open a pull request](https://github.com/daniyal44/reactive-resume-builder-44) with your example added to this page. Include:
