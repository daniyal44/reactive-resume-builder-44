...
- Docker Hub: `daniyal44/reactive-resume-builder-44:latest`
- GitHub Container Registry: `ghcr.io/daniyal44/reactive-resume-builder-44:latest`
...
```
    ...
    <Tip>
      Prefer pulling from Docker Hub? Keep <code>daniyal44/reactive-resume-builder-44:latest</code>. Prefer GHCR? Swap it to <code>ghcr.io/daniyal44/reactive-resume-builder-44:latest</code>.
    </Tip>
