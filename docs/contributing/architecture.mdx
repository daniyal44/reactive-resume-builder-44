...
<CardGroup cols={2}>
  <Card title="GitHub Discussions" icon="comments" href="https://github.com/daniyal44/reactive-resume-builder-44/discussions">
    Ask questions and discuss ideas with the community.
  </Card>
  <Card title="GitHub Issues" icon="bug" href="https://github.com/daniyal44/reactive-resume-builder-44/issues">
