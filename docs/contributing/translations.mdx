...
1. Go to the [GitHub Issues](https://github.com/daniyal44/reactive-resume-builder-44/issues) page
2. Click **New Issue**
...
<CardGroup cols={2}>
  ...
  <Card icon="github" title="GitHub Issues" href="https://github.com/daniyal44/reactive-resume-builder-44/issues">
